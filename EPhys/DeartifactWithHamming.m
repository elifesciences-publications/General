...
function artlessSignal = DeartifactWithHamming(signal,samplingInt, stimInds,preStimPeriod, postStimPeriod)

% DeartifactWithHamming - Remove stimulus artifacts. In contrast to
%                      Deartifact, subtracts Hamming modulated artifact for selected time
%                       period and also adds some Hamming modulated noise
%   data_mod = DeartifactWithHamming(data,samplingInt,stimIndices,preStimPeriod, postStimPeriod); 
%   data - signal vector
