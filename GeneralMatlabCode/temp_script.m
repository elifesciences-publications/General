...
%% SETTINGS
ngps = 3; %%%% Number of groups
gp1 = [1:3]; % Enter the file number that you want to place in this group. For instance if 7 files have been ins
gp2 = [4:7];
gp3 = [8:11];
gp4 =[];
...
fnum = gp(ingploop);
        ...
        for chNum = 1:numel(ch)-1 
            ...
            if ngps <=4
            plot(meh, 'color',colors{outgploop}), hold on,
            else             
