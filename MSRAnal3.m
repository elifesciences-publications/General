...
ss=inputdlg(prompt,'Please enter the sampling frequencies of the channels');
...
while (strcmp(showFig,'y') || strcmp(showFig,'yes') ||...
    ...
    xlim([(timeAxis.(chLabel)(capOnset2.(chLabel).(swLabel)-20))...
            (timeAxis.(chLabel)(capOnset2.(chLabel).(swLabel)+100))])
     shg
     hold off;
